...
public class DefaultBullet : MonoBehaviour
{
    ...
    {
        if (collision.CompareTag("Level") || collision.CompareTag("SwitchDoor") || collision.CompareTag("Box") || collision.CompareTag("Obsticales") || collision.CompareTag("Platforms") || collision.CompareTag("FloorBreakable"))
        {
